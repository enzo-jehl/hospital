...
INSERT INTO Patient (Patient_ID, Name, Gender, Date_of_Birth, Contact_Number, Address, contacted_department, Nurse_ID)
VALUES
  (1, 'Flavien Geoffray', 'M', '2003-10-03', '1234567890', '789 Maple Street', 'Cardiology', 1),
  (2, 'Alexiane Laroye', 'F', '2003-04-06', '9876543210', '567 Oakwood Avenue', 'Pediatrics', 2),
  (3, 'Enzo Jehl', 'M', '2003-10-10', '5555555555', '456 Elmwood Drive', 'Orthopedics', 3),
  (4, 'Wissame Ismael', 'M', '2004-08-29', '1516484622', '233 Togo Street', 'Neurology', 4);

INSERT INTO Doctor (Doctor_ID, Name, Speciality, Contact_Number, Email, Department_ID)
VALUES
  (1, 'Dr. Sarah Adams', 'Cardiology', '5551234567', 'sarah.adams@example.com', 1),
  (2, 'Dr. Michael Davis', 'Pediatrics', '5559876543', 'michael.davis@example.com', 2),
  (3, 'Dr. Jennifer Lee', 'Orthopedics', '5555555555', 'jennifer.lee@example.com', 3),
  (4, 'Dr. Doctor', 'Neurology', '5555522255', 'dotordoctor@example.com', 4);
